              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <a 
                    ...
                    className="flex items-center space-x-3 p-3 bg-ocean/10 hover:bg-ocean/20 text-ocean transition-colors duration-300"
                  >
                    <Heart className="w-5 h-5" />
                    <span className="font-medium">Community Pulse</span>
                  </a>
