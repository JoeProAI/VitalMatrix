...
import BoltNavbar from './BoltNavbar';
import BoltHeroSection from './BoltHeroSection';
import BoltFeaturesSection from './BoltFeaturesSection';
import BoltCommunitySection from './BoltCommunitySection';
import BoltNutriLensSection from './BoltNutriLensSection';
import BoltCtaSection from './BoltCtaSection';
import { ActivityIcon } from './icons';

const BoltSplashPage: React.FC = () => {
  useEffect(() => {
    console.log('BoltSplashPage component mounted');
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-bg to-dark-bg-secondary text-white overflow-x-hidden">
      ...
      <BoltHeroSection />
      <BoltFeaturesSection />
      <BoltCommunitySection />
      <BoltNutriLensSection />
      <BoltCtaSection />
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-6">
                <div className="w-8 h-8 bg-gradient-to-r from-[#00D4FF] to-[#B537F7] rounded-lg flex items-center justify-center">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li><a href="#" className="hover:text-electric-blue transition-colors">Community Pulse</a></li>
                <li><a href="#" className="hover:text-electric-blue transition-colors">NutriLens Scanner</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li><a href="#" className="hover:text-electric-blue transition-colors">Community Forum</a></li>
