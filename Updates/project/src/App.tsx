        ...
        <section className="py-24 px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
              <a href="/signup" className="bg-ocean text-pearl px-8 py-3 font-semibold text-base hover:bg-ocean-dark transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 inline-block text-center" style={{ clipPath: 'polygon(0 0, calc(100% - 16px) 0, 100% 100%, 16px 100%)' }}>
                Get Started Free
              </a>
              <button className="border-2 border-ocean text-ocean px-8 py-3 font-semibold text-base hover:bg-ocean/5 transition-all duration-300 transform hover:-translate-y-1" style={{ clipPath: 'polygon(16px 0, 100% 0, calc(100% - 16px) 100%, 0 100%)' }}>
                Schedule Demo
              </button>
            </div>
